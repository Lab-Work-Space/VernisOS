...
def main():
    ...
    parser.add_argument("--tcpsrv32", default=None, help="Optional x86 tcpsrv ELF (/bin/tcpsrv32)")
    parser.add_argument("--tcpsrv64", default=None, help="Optional x86_64 tcpsrv ELF (/bin/tcpsrv64)")
    parser.add_argument("--forktest32", default=None, help="Optional x86 forktest ELF (/bin/forktest32)")
    parser.add_argument("--forktest64", default=None, help="Optional x86_64 forktest ELF (/bin/forktest64)")
    ...
    # Phase 52: /bin/netcat32 + /bin/netcat64; Phase 65: /bin/tcpsrv32/64 (optional)
    for arg_path, fs_name in ((args.nc32, "/bin/netcat32"), (args.nc64, "/bin/netcat64"),
                              (args.tcpsrv32, "/bin/tcpsrv32"), (args.tcpsrv64, "/bin/tcpsrv64"),
                              (args.forktest32, "/bin/forktest32"), (args.forktest64, "/bin/forktest64")):
        if arg_path and os.path.exists(arg_path):
            with open(arg_path, "rb") as f:
                nc_data = f.read()
            if nc_data:
