...
// Phase 70: mount FAT32/ext2 test volumes under /mnt/fat32, /mnt/ext2.
// Both go through bcache_read(), so call this after bcache_init(), not
// from kfs_init() (which runs before the cache is up).
